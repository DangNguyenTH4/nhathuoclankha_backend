...
let AuthModuleRouting = class AuthModuleRouting {
};
...
let LoginComponent = class LoginComponent extends _nebular_auth__WEBPACK_IMPORTED_MODULE_2__["NbLoginComponent"] {
    constructor(log, customerControllerService, authService, tokenStorageService, nbAuthServe, options, cd, router) {
        super(nbAuthServe, options, cd, router);
        this.log = log;
        this.customerControllerService = customerControllerService;
        this.authService = authService;
        this.tokenStorageService = tokenStorageService;
        this.nbAuthServe = nbAuthServe;
...
let MyCoreModule = class MyCoreModule {
};
...
let JwtInterceptorService = class JwtInterceptorService {
    constructor(token, log, router, toast) {
        this.token = token;
        this.log = log;
        this.router = router;
        this.toast = toast;
...
//# sourceMappingURL=auth-auth-auth-module-es2015.js.map