...
var ImportMedicineRoutingModule = /** @class */ (function () {
    function ImportMedicineRoutingModule() {
    }
    ...
    return ImportMedicineRoutingModule;
}());
...
var ImportMedicineComponent = /** @class */ (function () {
    function ImportMedicineComponent(log, importMedicineControllerService, medicineControllerService, dialogService, toastService) {
        this.log = log;
    ...
    ImportMedicineComponent.prototype.ngOnInit = function () {
    };
    ImportMedicineComponent.prototype.prePareListMedicineDisplay = function () {
        var _this = this;
        this.medicineControllerService.getListAllMedicine().subscribe(function (data) {
            _this.listMedicines = data;
            _this.listMedicines.forEach(function (element) {
                _this.listMedicineDislay.push({ value: element.code, title: element.name });
            });
            _this.settings = _this.loadTableSetting();
        }, function (error) { _this.settings = _this.loadTableSetting(); });
    };
    ImportMedicineComponent.prototype.loadTableSetting = function () {
        return {
            action: {
                add: true,
                edit: true,
    ...
    ImportMedicineComponent.prototype.selectType = function (event) {
        var _this = this;
        // this.type = event.value
        this.customer.type = event;
        this.source.getAll().then(function (data) {
            data.forEach(function (e) {
                var medicine = _this.listMedicines.find(function (m) { return m.code === e.medicineCode; });
                if (_this.customer.type === 'company') {
                    e.medicinePrice = medicine.priceForCompany;
                }
                else if (_this.customer.type === 'farm') {
    ...
    ImportMedicineComponent.prototype.notifyBeforeCreate = function (dialog) {
        var _this = this;
        this.log.log(this.date.toISOString());
        var message = this.validateWhenCreateOrder();
        if (message !== "ok") {
            // this.notify(message);
            this.toastService.notify(4, "Lỗi", message);
            return;
        }
        this.dialogService.open(dialog).onClose.subscribe(function (isOke) {
            if (isOke)
                _this.createOrder();
        });
    };
    ImportMedicineComponent.prototype.createOrder = function () {
        var _this = this;
        var importOrderDto = { id: null, importDate: this.date, listMedicineImport: [], staffName: 'dangnt' };
        this.source.getAll().then(function (data) {
            if (data.length === 0) {
                _this.toastService.notify(4, "Lỗi", "Chưa có thuốc nào được nhập!");
                return;
            }
            ...
            _this.importMedicineControllerService.createImportOrder(importOrderDto).subscribe(function (data) {
                _this.resetData();
                _this.toastService.notify(1, "Thành công", "Thêm thành công!");
            }, function (error) {
                _this.toastService.notify(4, "Lỗi", error.error.message);
            });
        });
    };
    ImportMedicineComponent.prototype.onDeleteConfirm = function (event) {
    ...
    ImportMedicineComponent.prototype.onCreateConfirm = function (event) {
        this.editOrCreateNewMedicine(event);
    };
    ImportMedicineComponent.prototype.onEditConfirm = function (event) {
        this.editOrCreateNewMedicine(event);
    };
    ImportMedicineComponent.prototype.editOrCreateNewMedicine = function (event) {
        var validateMessage = this.validateRow(event.newData);
    ...
    ImportMedicineComponent.prototype.updateInfoRow = function (newData) {
        var medicine = this.listMedicines.find(function (e) { return e.code == newData.medicineCode; });
    ...
    ImportMedicineComponent.prototype.validateRow = function (newData) {
        var result = "ok";
        if (newData) {
    ...
    ImportMedicineComponent.prototype.validateWhenCreateOrder = function () {
        var result = "ok";
        var length = this.source.count();
        if (length === 0) {
            result = "Đơn hàng trống!";
        }
        return result;
    };
    ImportMedicineComponent.prototype.notify = function (message) {
    ...
    ImportMedicineComponent.prototype.resetData = function () {
        this.customer = {};
        this.source.load([]);
    };
    ...
    return ImportMedicineComponent;
}());
...
var ImportMedicineModule = /** @class */ (function () {
    function ImportMedicineModule() {
    }
...
//# sourceMappingURL=import-medicine-import-medicine-module-es5.js.map