...
class GenerateFileName {
    static genfileName(customerName) {
    ...
    static genNormalReportName(fromDate, toDate, something) {
        return 'Báo cáo ' + something + fromDate + '-' + toDate;
    }
    static printListMedicine() {
...
class InvoiceRow {
    constructor(productName, unitPrice, addMore, qty, unit) {
...
//# sourceMappingURL=default~report-report-module~sell-medicine-sell-medicine-module-es2015.js.map